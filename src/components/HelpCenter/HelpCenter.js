  ...
  const cards = [
    {
      ...
      text: t("helpCenter.account"),
      desc: t("helpCenter.account_desc"),
      alt: "Account Icon",
      tab: "account",
    },
    {
      img: "/images/help.png",
      text: t("helpCenter.general"),
      desc: t("helpCenter.general_desc"),
      alt: "General Icon",
      tab: "general",
    },
    {
      img: "/images/competitive.png",
      text: t("helpCenter.plans"),
      desc: t("helpCenter.plans_desc"),
      alt: "Plans Icon",
      tab: "plans",
    },
    {
      img: "/images/graphic-design.png",
      text: t("helpCenter.website"),
      desc: t("helpCenter.website_desc"),
      alt: "Website Design Icon",
      tab: "website",
    },
    {
      img: "/images/brand-identity.png",
      text: t("helpCenter.brand_identity"),
      desc: t("helpCenter.brand_desc"),
      alt: "Brand Identity Icon",
      tab: "brand",
    },
    {
      img: "/images/marketing.png",
      text: t("helpCenter.marketing"),
      desc: t("helpCenter.marketing_desc"),
      alt: "Marketing Icon",
      tab: "marketing",
    },
  ];
